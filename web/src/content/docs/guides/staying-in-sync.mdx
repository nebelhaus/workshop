...
<Aside type="note" title="haus vs. bench vs. wt">
The `haus` on your `PATH` (documented here) manages **your machine** — it's all
you need as an end user. The rice also ships **[`wt`](/guides/claude-agents/)**
for Claude Code agent worktrees (useful to anyone, contributor or not), and
family *contributors* get a separate **[`bench`](/internals/contributing/)** CLI
in the workshop for moving changes between repos. See
[the CLIs at a glance](/start/the-family/#the-clis-at-a-glance) for the full map.
</Aside>
