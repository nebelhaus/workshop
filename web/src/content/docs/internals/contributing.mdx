...
5. **release** — bump the version and `./bench release <repo>`; CI does the
   rest. Two repos are releasable: **pounce** (GitHub release + Homebrew
   formula bump) and **nebelhaus** (the tag becomes what
...
url/sha; bump the version in the source first, then release. And because the
installer serves the latest **rice** release, user-visible rice changes aren't
