...
5. **release** — `./bench release <repo>`; CI does the rest. Two repos are
   releasable: **pounce** (GitHub release + Homebrew formula bump) and
   **nebelhaus** (the tag becomes what `nebelhaus.com/init.sh` serves to new
   installs).
